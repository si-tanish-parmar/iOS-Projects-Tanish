...
class ChatViewController: MessagesViewController{
    ...
    private func configureGestureRecognizer(){
        longPressedGesture = UILongPressGestureRecognizer(target: self, action: #selector(recordAudio))
    ...
    @objc func recordAudio(){
        ...
        case .ended:
            ...
            if fileExistsAtPath(path: audioFilename + ".m4a"){
                let audioD = audioDuartion.interval(ofComponent: .second, from: Date())
